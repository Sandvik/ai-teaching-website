...
export default function AIInklusion({ content }) {
...
export async function getStaticProps() {
  try {
    ...
    const enContent = fs.readFileSync(path.join(process.cwd(), 'content/en/ai-inclusion.md'), 'utf8');
    ...
    console.error('Error loading AI inklusion content:', error);
    return {
      props: {
        content: {
