...
export default function MinisterietAnbefalinger({ content }) {
  ...
  return (
    <>
      <SEO
        title={locale === 'da' ? 'Ministeriets Anbefalinger: Generativ AI i Folkeskolen | ai-skole.dk' : 'Ministry Recommendations: Generative AI in Primary Education | ai-skole.dk'}
        description={locale === 'da'
          ? 'Læs de officielle retningslinjer og anbefalinger fra Undervisningsministeriet om brug af generativ AI i folkeskolen. Få styr på GDPR, pædagogik, forældreinddragelse og praktiske eksempler.'
          : 'Read the official guidelines and recommendations from the Danish Ministry of Education on the use of generative AI in primary education. GDPR, pedagogy, parent involvement, and practical examples.'}
        keywords={locale === 'da'
          ? 'ministeriets anbefalinger, AI i folkeskolen, generativ AI, officielle retningslinjer, AI undervisning, AI GDPR, AI forældre, AI pædagogik, AI skolen, AI Danmark'
          : 'ministry recommendations, generative AI, official guidelines, AI in primary education, AI teaching, AI GDPR, AI parents, AI pedagogy, AI Denmark'}
        url={locale === 'da' ? 'https://ai-skole.dk/ministeriet-anbefalinger' : 'https://ai-skole.dk/ministeriet-anbefalinger'}
        image="https://ai-skole.dk/og-image.png"
        canonical={locale === 'da' ? 'https://ai-skole.dk/ministeriet-anbefalinger' : 'https://ai-skole.dk/ministeriet-anbefalinger'}
        structuredData={{
          '@context': 'https://schema.org',
          '@type': 'Article',
          'headline': locale === 'da' ? 'Ministeriets Anbefalinger: Generativ AI i Folkeskolen' : 'Ministry Recommendations: Generative AI in Primary Education',
          'description': locale === 'da'
            ? 'Læs de officielle retningslinjer og anbefalinger fra Undervisningsministeriet om brug af generativ AI i folkeskolen. Få styr på GDPR, pædagogik, forældreinddragelse og praktiske eksempler.'
            : 'Read the official guidelines and recommendations from the Danish Ministry of Education on the use of generative AI in primary education. GDPR, pedagogy, parent involvement, and practical examples.',
          'inLanguage': locale,
          'author': {
            '@type': 'Organization',
            'name': locale === 'da' ? 'Børne- og Undervisningsministeriet' : 'Ministry of Education'
          },
          'publisher': {
            '@type': 'Organization',
            'name': 'ai-skole.dk',
          ...
          'mainEntityOfPage': {
            '@type': 'WebPage',
            '@id': locale === 'da' ? 'https://ai-skole.dk/ministeriet-anbefalinger' : 'https://ai-skole.dk/ministeriet-anbefalinger'
          }
        }}
      />
      <Layout>
